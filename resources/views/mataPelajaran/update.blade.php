...
<div class="container py-4">
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body" style="background-color: #ffffff;">
            <form action="{{ route('mataPelajaran.update',  $mataPelajaran->id) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="kode" id="kode"  value="{{ $mataPelajaran->kode }}"  class="form-control"> 
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"  name="mata_pelajaran" id="mata_pelajaran" value="{{ $mataPelajaran->mata_pelajaran }}" class="form-control">
                                </div>
                            </div>
