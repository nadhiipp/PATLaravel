        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('sumbitLogin') }}">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" value="" placeholder="Masukan NIP/NIS" required autofocus>
                                    @error('username')
                        ...
                        <div class="text-center">
                           <a href="{{ url('/DashboardAdmin') }}">
                            ...
                            <p class="form-text">Login with your social media account</p>
